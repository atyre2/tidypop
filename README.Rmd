...
[![Codecov test coverage](https://codecov.io/gh/atyre2/tidypop/branch/master/graph/badge.svg)](https://codecov.io/gh/atyre2/tidypop?branch=master)
<!-- badges: end -->
...
but you can install the stable version from [GitHub](https://github.com/) with:
