...
[![Travis build status](https://travis-ci.org/atyre2/tidypop.svg?branch=dev)](https://travis-ci.org/atyre2/tidypop)
[![AppVeyor build status](https://ci.appveyor.com/api/projects/status/github/atyre2/tidypop?branch=dev&svg=true)](https://ci.appveyor.com/project/atyre2/tidypop)
